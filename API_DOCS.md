...
- **URL:** `https://thirapi-three.vercel.app/api/now-playing`
- **Method:** `GET`
...
- **Usage Example (Markdown):**
  ```markdown
  ![Now Playing](https://thirapi-three.vercel.app/api/now-playing)
  ```
...
- **URL:** `https://thirapi-three.vercel.app/api/now-playing/card`
- **Method:** `GET`
- **Description:** Generates and returns an SVG image of the card-style "Now Playing" status.
- **Usage Example (Markdown):**
  ```markdown
  ![Now Playing Card](https://thirapi-three.vercel.app/api/now-playing/card)
  ```
- **Preview:**
  ![Now Playing Card](https://thirapi-three.vercel.app/api/now-playing/card)
...
- **URL:** `https://thirapi-three.vercel.app/api/now-playing/dvd`
- **Method:** `GET`
- **Description:** Generates and returns an SVG image of the DVD-style "Now Playing" status with a spinning animation.
- **Usage Example (Markdown):**
  ```markdown
  ![Now Playing DVD](https://thirapi-three.vercel.app/api/now-playing/dvd)
  ```
- **Preview:**
  ![Now Playing DVD](https://thirapi-three.vercel.app/api/now-playing/dvd)
